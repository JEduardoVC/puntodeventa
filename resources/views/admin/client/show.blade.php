                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <div class="border-bottom py-4">
                                <div class="list-group">
                                    <button type="button" class="list-group-item list-group-item-action active">Sobre Client</button>
                        ...
                        <div class="col-lg-8 pl-lg-5">
                            <div class="d-flex justify-content-between">
                                <h4>Información del Client</h4>
                            </div>
                            <div class="profile-feed">
                                <div class="d-flex align-items-start profile-feed-item">
                                    <div class="form-group col-md-6">
                                        <strong><i class="fab fa-product-hunt mr-1"></i>Nombre</strong>
                                        <p class="text-muted">{{$client->name}}</p><hr>
                                        <strong><i class="fas fa-address-card mr-1"></i>Número de Documento</strong>
                                        <p class="text-muted">{{$client->ruc}}</p><hr>
                                        <strong><i class="fas fa-address-card mr-1"></i>Número de DNI</strong>
                                        <p class="text-muted">{{$client->dni}}</p><hr>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <strong><i class="fas fa-mobile-alt mr-1"></i>Teléfono</strong>
                                        <p class="text-muted">{{$client->phone}}</p><hr>
                                        <strong><i class="fas fa-envelope mr-1"></i>Email</strong>
                                        <p class="text-muted">{{$client->email}}</p><hr>
                                        <strong><i class="fas fa-map-marked-alt mr-1"></i>Dirección</strong>
                                        <p class="text-muted">{{$client->address}}</p><hr>
                                    </div>
                                </div>
                            </div>
                        </div>
