                        ...
                        <table id="order-listing" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route("roles.show",$role)}}">{{$role->name}}</a></td>
                                        <td>{{$role->guard_name}}</td>
                                        <td style="width: 50px">
                                            {!! Form::open(["route"=>["roles.destroy",$role],"method"=>"DELETE"]) !!}
                                            <a class="jsgrid-button jsgrid-edit-button unstyled-button" type="button" href="{{route("roles.edit",$role)}}" title="Editar">
